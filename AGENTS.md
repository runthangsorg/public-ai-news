# Agent instructions — public-ai-news
...
Recurring GitHub-hosted compute for the daily AI news digest, on free standard runners
(news-digest.yml). Keep it that way: no self-hosted runners, no
